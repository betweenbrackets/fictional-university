<!-- This page powers the non-JavaScript search page used if the JavaScript powered search overlay is not loading -->

<!-- This page is based on page.php -->
